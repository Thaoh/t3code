...
// Databases on feat/thread-parking recorded migration id 46 as
// ProjectionProjectsDefaultThreadEnvModeRepair before main claimed that id
// for RepairAutomaticSettlementTimestamps. Those databases skip the real
// migration; re-run the same UPDATE at an id they have not seen. Databases
// migrated from main already repaired stamps and this is a no-op.
