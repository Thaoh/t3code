...
// Databases on feat/thread-parking recorded migration id 44 as
// ProjectionTurnsKeysetIndexRepair before main claimed that id for
// ClearAutomaticProjectModelDefaults. Those databases skip the real
// migration; re-run the same guarded UPDATEs at an id they have not seen.
// Databases migrated from main already applied the clear and this is a no-op.
