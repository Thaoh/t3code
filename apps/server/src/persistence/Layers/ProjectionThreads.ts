...
import { ModelSelection, ThreadLinkedPullRequest, ThreadParkedNote } from "@t3tools/contracts";

const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    modelSelection: Schema.fromJsonString(ModelSelection),
    parkedNote: Schema.NullOr(Schema.fromJsonString(ThreadParkedNote)),
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.branch},
          ${row.worktreePath},
          ${row.parkedNote === null ? null : JSON.stringify(row.parkedNote)},
        ...
        DO UPDATE SET
          ...
          parked_note_json = excluded.parked_note_json,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          parked_note_json AS "parkedNote",
